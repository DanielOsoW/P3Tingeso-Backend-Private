...
insert into diplomado (titulo,introduccion,objetivo,descripcion,horas,cursos,imagen) values 
    ...
    El programa busca por medio de un enfoque aplicado generar habilidades de programación, exploración
     y modelamiento de datos, finalizando con un proyecto práctico en donde se aplican los conocimientos
      y herramientas vistas, buscando dar solución a problemáticas mediante la ciencia de datos. \n
    El diplomado está estructurado en 6 módulos y tiene una duración de 180 horas cronológicas con 120 
    ...
    información dentro de la organización. Además, les permitirá conocer y aplicar buenas prácticas 
    para gestionar, definir y documentar políticas y riesgos de ciberseguridad para la compañía.\n
    ...
    por ejemplo, su rendimiento financiero y la infraestructura tecnológica. Por lo tanto, la necesidad
     de vigilar y controlar los riesgos se vuelve evidente y prioritario. \n
    En las organizaciones y empresas, especialmente del rubro financiero, el tipo de riesgo operacional
    ha tomado especial relevancia en los últimos años. Este es definido por el Comité de Basilea como 
    riesgo de pérdida resultante de inadecuados o fallidos procesos internos, de las personas y de
    los sistemas, como también de acontecimientos externos”. Esta definición considera tanto el riesgo
    financiero como el tecnológico, siendo este último, de especial relevancia, dado que las empresas
    son cada vez más dependientes de una infraestructura tecnológica para alcanzar sus objetivos de
    negocio.\n
    La desregulación y la globalización de los servicios financieros, junto con la creciente 
    sofisticación de la tecnología, han creado una variedad de nuevos riesgos para todo tipo de 
    organizaciones. Estos se han enfrentado con nuevas regulaciones (PCI/DSS, SOX, HIPAA), normativas
    (Basilea III, Solvencia), Leyes (Ley 19799, Ley 19628) y estándares (ISO 31000, ISO 22301, ISO 
    ...
    información. Finalmente se abordan procedimientos y controles que permitan disminuir o evitar el
    ...
    conocimientos adecuados, las exigencias de esta nueva disciplina en el ámbito legislativo, 
    judicial y policial.\n
    El programa contempla en su desarrollo, clases, magistrales, casos prácticos como teóricos,
